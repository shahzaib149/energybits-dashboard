// Minimal dependency-free PDF builder shared by the AEO and SEO analytics reports.
// Emits a valid PDF 1.4 document by hand: object table, xref offsets, and a small
// content-stream drawing toolkit (filled/stroked rects, rules, colored text) styled
// to match the dashboard's slate + cyan theme.
...
export const INK = "0.059 0.090 0.165"; // slate-950
export const MUTED = "0.392 0.455 0.545"; // slate-500
export const BORDER = "0.796 0.835 0.882"; // slate-300
export const LIGHT = "0.945 0.961 0.976"; // slate-100
export const CYAN = "0.031 0.569 0.698"; // cyan-600
export const CYAN_DARK = "0.055 0.455 0.565"; // cyan-700
export const WHITE = "1 1 1";
export const ON_INK = "0.796 0.835 0.882"; // muted text on the dark header band
...
export class PdfReport {
  ...
  constructor(footerLabel = "ENERGYbits Report") {
  ...
  private drawFooter() {
    ...
    this.drawText(this.footerLabel, MARGIN, y, 7.5, { color: MUTED });
...
export function truncate(text: string, maxWidth: number, size: number): string {
